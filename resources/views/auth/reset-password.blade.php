		    ...
		    <form method="POST" action="{{ route('password.store') }}">@csrf
			  ...
			  <label for="exampleInputEmailId" class="sr-only">Email ID</label>
			   <div class="position-relative has-icon-right">
                  ...
                  <x-text-input id="email" class="form-control input-shadow" type="email" name="email" :value="old('email', $request->email)" required autofocus autocomplete="username" placeholder="Enter Your Email ID"/>
			  ...
			  <div class="form-group">
			   ...
			   <div class="position-relative has-icon-right">
                  ...
                  <x-text-input id="password" class="form-control input-shadow" type="password" name="password" required autocomplete="new-password" placeholder="Choose Password"/>
