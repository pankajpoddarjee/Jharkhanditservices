		    ...
		    <form method="POST" action="{{ route('register') }}">@csrf
			  ...
			  <label for="exampleInputName" class="sr-only">Name</label>
			   <div class="position-relative has-icon-right">
                  ...
                  <x-text-input id="name" class="form-control input-shadow" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" placeholder="Enter Your Name"/>
			  ...
			  <label for="exampleInputEmailId" class="sr-only">Email ID</label>
			   <div class="position-relative has-icon-right">
                  ...
                  <x-text-input id="email" class="form-control input-shadow" type="email" name="email" :value="old('email')" required autocomplete="username" placeholder="Enter Your Email ID"/>
			  ...
			  <div class="form-group">
			   ...
			   <div class="position-relative has-icon-right">
                  ...
                  <x-text-input id="password" class="form-control input-shadow"
                            type="password"
                            name="password"
                            required autocomplete="new-password" placeholder="Choose Password"/>
              ...
              <div class="form-group">
			   ...
			   <div class="position-relative has-icon-right">
				  <!-- <input type="text" id="exampleInputPassword" class="form-control input-shadow" placeholder="Choose Password"> -->
                  <x-text-input id="password_confirmation" class="form-control input-shadow"
                            type="password"
              ...
              <x-primary-button class="btn btn-light btn-block waves-effect waves-light">
                {{ __('Register') }}
            </x-primary-button>
